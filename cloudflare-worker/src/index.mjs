...
const PRODUCT = Object.freeze({"org": "apostille-me", "name": "Apostille Me", "tagline": "Apostille orchestration for expats, families, founders, and immigration teams.", "audience": "expats, immigration lawyers, document runners, remote workers, and families handling multi-jurisdiction paperwork", "integrations": ["UPS/FedEx tracking", "Google Drive", "Notary queues", "Translation vendors", "Embassy checklists", "Email/SMS updates"], "capabilities": ["intake", "case-status", "documents", "events", "alerts", "audit"]});
