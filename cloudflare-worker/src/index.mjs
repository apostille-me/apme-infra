...
const PRODUCT = Object.freeze({
  ...
  audience:
    'expats, immigration lawyers, document runners, remote workers, and families handling multi-jurisdiction paperwork',
  integrations: [
    'UPS/FedEx tracking',
    'Google Drive',
    'Notary queues',
  ...
  capabilities: ['intake', 'case-status', 'documents', 'events', 'alerts', 'audit'],
});
