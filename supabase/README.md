# Supabase overlays for apostille-me
...
**`apostille_me`**. Every migration in these overlays must stay inside `apostille_me`; the first migration creates it and
...
- **Authority does not move.** Portable SQL and JSON Schema stay in `apostille-me/apme-lib-core` (lib-core tier).
